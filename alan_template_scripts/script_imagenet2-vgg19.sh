#!/bin/bash
#
#SBATCH --job-name=image2v
#SBATCH --output=/home/lsacre/outputs/imagenet2_vgg-%j.txt
#
#SBATCH --ntasks=1
...
# srun python3 imagenet/2/main-distance.py --size 300 --arch vgg19_bn
srun python3 imagenet/2/main.py --size 300 --arch vgg19_bn --shift 75
